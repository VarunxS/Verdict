    ...
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 rounded-none",
    {
        variants: {
            variant: {
                ...
                terminal: "bg-transparent border border-[#00ff00] text-[#00ff00] hover:bg-[#00ff00]/10 font-mono tracking-wider",
                verdict: "bg-[#3b82f6] text-white hover:bg-[#2563eb] shadow-sm",
                consulting: "bg-[#10b981] text-white hover:bg-[#059669] shadow-sm"
            },
            size: {
